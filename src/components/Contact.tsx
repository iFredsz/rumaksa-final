...
const Contact = () => {
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                {[
                  { icon: Phone, text: '+62 858-659-3347' },
                  ...
                  <div key={index} className="flex items-center space-x-2">
                    ...
                    <span className="text-description">{item.text}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          >
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-base font-medium text-description mb-2">Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-base font-medium text-description mb-2">Email</label>
                <input
                  type="email"
                  name="email"
            ...
            <div>
              <label className="block text-base font-medium text-description mb-2">Subject</label>
              <input
                type="text"
                name="subject"
            ...
            <div>
              <label className="block text-base font-medium text-description mb-2">Message</label>
              <textarea
                name="message"
  ...
  className="w-full px-4 py-2 bg-[var(--accent)] hover:bg-sky-600 rounded-lg font-medium text-header-text flex items-center justify-center space-x-2 transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-[var(--accent)]"
>
